...
Open the Amazon Scraper Extension Page
Chrome
Download ZIP
Extract it
...
Click Load Unpacked
Select the `amazon_scrapper-main` folder
Firefox
Available on Firefox Add-ons — search Amazon Product Scraper by Steve Gates.
---
⚡ Usage
Open any Amazon product page
Click the extension icon in your toolbar
Click 🔍 Scrape Page
Use the two copy buttons:
